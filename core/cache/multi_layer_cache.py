...
class MultiLayerCache:
    ...
    def __init__(
        ...
        self._l2_ttl = l2_ttl
        self._l2_client: Any | None = None  # redis.Redis or None
...
_AI_ANALYSIS_CACHE: MultiLayerCache | None = None
_MARKET_DATA_CACHE: MultiLayerCache | None = None
_SMC_ANALYSIS_CACHE: MultiLayerCache | None = None
