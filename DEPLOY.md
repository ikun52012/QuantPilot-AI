...
`AUTO_UPDATE_ENABLED=true docker compose --profile updates up -d`. The updater needs
the host Docker socket, so leave it disabled unless you need one-click rollouts.
